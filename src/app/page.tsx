            ...
            <div className="flex gap-x-1 pt-1 font-mono text-sm text-muted-foreground print:hidden">
              {RESUME_DATA.contact.email ? (
                <Button
                  ...
                  asChild
                >
                  <a href={`mailto:${RESUME_DATA.contact.email}`} aria-label="Send email" title="Send email">
              ...
              {RESUME_DATA.contact.social.map((social) => (
                <Button
                  ...
                  asChild
                >
                  <a href={social.url} aria-label={`${social.name} profile`} title={`${social.name} profile`}>
